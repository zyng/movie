                            ...
                            <div className="movie__content">
                                ...
                                <div className="movie__actions">
                                    <div className="movie__add">
                                        <div className="movie__action"><a href=""></a><span>Must watch</span></div>
                                        <div className="movie__action"><a href=""></a><span>Best of</span></div>
                                        <div className="movie__action"><a href=""></a><span>Classic</span></div>
                                        <div className="movie__action"><a href=""></a><span>Black list</span></div>
                                    </div>
                                </div>
                            </div>
